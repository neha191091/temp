...
import Box2D
from Box2D import b2, b2ContactListener
...
if __name__ == "__main__":
    ...
    # enable variables of interest (agent state)
    ...
    for i in range(episodes):
        ...
        while not game.is_episode_finished():
            ...
            print(picture.shape)
            plt.imsave('results/'+str(1)+'_'+str(n)+'.png', picture)
            ...
            #picture = state.screen_buffer
            #plt.imsave('results/' + str(2) + '_' + str(n) + '.png', picture)
