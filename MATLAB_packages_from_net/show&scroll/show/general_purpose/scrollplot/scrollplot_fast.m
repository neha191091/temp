function scrollplot_fast(a, dim, offset)
...
% scrollplot(gca,1)					% go to next layer along 1st dimension, i.e. [2] (later called [2 1])
% scatter(randn(1,100),randn(1,100))	% draw at current layer
% scrollplot(gca,1)					% go to next layer along 1st dimension, i.e. [3] (later called [3 1])
% scatter(randn(1,100),randn(1,100))	% draw at current layer
% scrollplot(gca,2)					% go to next layer along 2nd dimension, starting at layer [1 2]
% scatter(randn(1,100),randn(1,100))	% draw at current layer
% scrollplot(gca,1)					% go to next layer along 1st dimension, i.e. [2 2]
% scatter(randn(1,100),randn(1,100))	% draw at current layer
% scrollplot(gca,1)					% go to next layer along 1st dimension, i.e. [3 2]
% scatter(randn(1,100),randn(1,100))	% draw at current layer
% scrollplot(gca,[],[-1 -1])			% go back by [-1 -1] to layer [2 1]
